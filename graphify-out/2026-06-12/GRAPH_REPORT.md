...
## Corpus Check
- 45 files · ~463,105 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 793 nodes · 1064 edges · 64 communities (54 shown, 10 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 74 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `60a38c48`
...
Cohesion: 0.22
Nodes (9): default, title, type, font_path, uppercase, properties, default, title (+1 more)
...
Cohesion: 0.12
Nodes (21): Video composition orchestration., Compose raw video from assets with immutable parameters.          Args:, GaugeOverlay, NameplateOverlay, Character nameplate with position., Create nameplate clip., Subtitle text with styling., Create styled subtitle clip. (+13 more)

### Community 23 - "Community 23"
Cohesion: 0.16
Nodes (18): AssetBundle, Orchestrates video composition with injected dependencies., RawVideoCompositor, GroundingDINOHeadDetector, HeadDetector, HeadLayout, Head detection for character positioning., Detected head positions (normalized 0-1). (+10 more)

### Community 28 - "Community 28"
Cohesion: 0.25
Nodes (6): Overlay, Port for video overlays (subtitles, timers, nameplates, etc.)., Render overlay as a MoviePy Clip., Create animated gauge clip., Protocol, VideoClip

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (37): additionalProperties, description, properties, required, title, type, additionalProperties, properties (+29 more)

### Community 30 - "Community 30"
Cohesion: 0.25
Nodes (8): text, voice_id, title, type, default, title, type, properties
...
Cohesion: 0.19
Nodes (14): OpenAI, Feature-driven pipeline orchestration with immutable outputs., Transcription, Cue, Complete transcription as immutable tuple of cues., Convert to list of dicts for backwards compat with metadata.json., Port for speech-to-text services., Transcribe audio file and return cues with timing. (+6 more)
...
Cohesion: 0.22
Nodes (9): TimerStyle, size, default, title, type, additionalProperties, properties, title (+1 more)
...
Cohesion: 0.25
Nodes (8): properties, oneOf, title, placement, stroke_width, default, title, type
...
Cohesion: 0.18
Nodes (8): AssetProvider, Synthesize voice using Minimax Speech model., Generate image using ByteDance SeedDream model., Generate animated video using Pruna P-Video model., Generate assets using Replicate AI models., ReplicateAssetProvider, HeadDetector, Transcriber
...
Cohesion: 0.33
Nodes (6): VoiceAsset, additionalProperties, description, required, title, type
...
Cohesion: 0.20
Nodes (10): $defs, NameplateSpec, SubtitleStyle, additionalProperties, required, title, type, additionalProperties (+2 more)

### Community 53 - "Community 53"
Cohesion: 0.07
Nodes (29): HeadAnchor, ZoomEffect, additionalProperties, description, properties, required, title, type (+21 more)
...
Cohesion: 0.50
Nodes (4): default, title, type, color
...
Cohesion: 0.50
Nodes (4): default, title, type, fontsize
...
- **Why does `$defs` connect `Community 52` to `Community 32`, `Community 34`, `Community 37`, `Community 39`, `Community 9`, `Community 42`, `Community 43`, `Community 45`, `Community 46`, `Community 48`, `Community 53`, `Community 29`?**
...
- **What connects `Format final de la vidéo (validé avec l'auteur)`, `Doctrine voix (hybride — décision auteur)`, `L'enjeu n°1 : les prompts (décision auteur — « optimiser un maximum sans diluer »)` to the rest of the system?**
